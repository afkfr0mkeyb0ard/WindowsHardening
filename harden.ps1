...
# =============================================
# 6. APPLICATION & FEATURE HARDENING
# =============================================
...
if (-not (Test-Path "HKCU:\System\GameConfigStore")) { New-Item -Path "HKCU:\System" -Name "GameConfigStore" -Force }
